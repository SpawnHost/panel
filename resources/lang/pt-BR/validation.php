...
return [
    ...
    | de validação. Algumas dessas regras possuem várias versões, como as regras
    | de tamanho. Sinta-se à vontade para ajustar cada uma dessas mensagens.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar os placeholders de atributos
    | por algo mais legível, como "Endereço de E-mail" ao invés de "email".
    | Isso ajuda a deixar as mensagens um pouco mais claras.
    |
    */

    'attributes' => [],

    // Lógica de validação interna do Pterodactyl
    'internal' => [
